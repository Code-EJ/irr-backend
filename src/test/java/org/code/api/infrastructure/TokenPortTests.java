...
public class TokenPortTests {
    ...
    public TokenPortTests() {
        ...
        SecurityBeansConfig securityBeans = new SecurityBeansConfig(
            new RSAConfigProps(publicKey, privateKey)
        );
    ...
    @Test
    @DisplayName(
        "Should throw InvalidToken exception when decoding invalid JWT format"
    )
    ...
    @Test
    @DisplayName(
        "Should throw InvalidToken exception when decoding malformed token"
    )
    ...
    @Test
    @DisplayName(
        "Should throw InvalidToken exception when decoding empty token"
    )
    ...
    @Test
    @DisplayName(
        "Should throw InvalidToken exception when decoding token with invalid signature"
    )
